                    ...
                    if len(data) != 2:
                        ...
                        # reset sensors command
                            ...
                            if is_an_actuator:
                                ...
                                print(
                                    f"MOTE {self.source_ip[-1]}, pin {pin_num} is an actuator with the state {actuator_state} with the interface of {interface_type_number}"
                                )
                                packet = bytearray(5)
                                ack_pin = 100 + pin_num
                                ...
                                print(
                                    f"MOTE {self.source_ip[-1]}, pin {pin_num}  is a sensor with the interface {interface_type_number}"
                                )
...
def spawn_mote_threads(config_name):
    ...
    try:
        ...
        print("Please Make sure that the configuration file is in the configs folder")
